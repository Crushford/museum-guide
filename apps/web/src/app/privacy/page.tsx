...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Museum Guide',
};
    ...
    <main className="mx-auto max-w-3xl px-6 py-12">
      <div className="prose prose-neutral max-w-none">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Privacy Policy) refers to Museum Guide.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Museum Guide, accessible from{' '}
              <a
                href="http://museumguide.io"
        ...
        <p>
          ...
          settings. Withdrawing consent does not affect the lawfulness of
        ...
        <p>
          ...
          retention periods to different categories of Personal Data based on
        ...
        <ul>
          <li>By email: museumguideio@gmail.com</li>
        </ul>
      </div>
    </main>
  );
